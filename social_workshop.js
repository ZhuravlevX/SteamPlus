(function replaceSocialIcons() {
        ...
        document.querySelectorAll('a.general_btn.panel_btn').forEach(btn => {
            btn.childNodes.forEach(node => {
                if (node.nodeType === Node.TEXT_NODE) {
                    if (node.textContent.includes("Твиттере")) {
    ...
    (function replaceSharePopupTwitter() {
        ...
        if (twBtn) {
            if (twBtn.title && twBtn.title.includes("Твиттере")) {
                twBtn.title = twBtn.title.replace(/Твиттере/g, "X");
            }
            ...
            twBtn.childNodes.forEach(node => {
                if (node.nodeType === Node.TEXT_NODE && node.textContent.includes("Поделиться в Твиттере")) {
                    node.textContent = node.textContent.replace(/Поделиться в Твиттере/g, "Поделиться в X");
                }
            });
        }
    })();
